...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    ArrayList<LatLng>coo=new ArrayList<>();
    TinyDB db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_maps);
        btn_start=findViewById(R.id.start_tracking);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.start_tracking:
                if(btn_start.getText().equals("Start Tracking")) {
                    btn_start.setText("Stop Tracking");
                    startService(new Intent(getApplicationContext(), LocationService.class));
                }
                else {
                    btn_start.setText("Start Tracking");
                   ...
                   /* mGoogleMap.addPolyline((new PolylineOptions())
                    ...
                    mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LOWER_MANHATTAN,
                            13));*/
                   lat=db.getListDouble("latitude");
                   lan=db.getListDouble("longitude");
                    Log.e("LATTT","Lattt"+lat.size()+"\t"+lat);

                    if(lat.size()>0) {
                        for (int i = 0; i < lat.size(); i++) {

                            coo.add(new LatLng(lat.get(i), lan.get(i)));

                        }
                    }

                            for (int i = 0; i < coo.size() - 1; i++) {
                                LatLng src = coo.get(i);
                                LatLng dest = coo.get(i + 1);
    ...
    public class ServiceToActivity extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
           ...
           Log.e("only latitude","only latitude"+lat);
